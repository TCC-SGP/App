...
import Listagem from "../func/Listagem_doacao";

export default function Listar_doacoes({navigation}) {
    ...
    async function listarDados() {
        try {
            ...
            const res = await axios.get("http://192.168.183.61/api_sgpApp/listar_doacoes.php");
      ...
      >
            ...
            <View style={styles.tabNav}>
                ...
                <View style={styles.areaBtnTab}>
                    <TouchableOpacity
                        style={[styles.botaoTab, { backgroundColor: "#4F7063" }]}
                        onPress={() => navigation.navigate('Cadastrar Doações')}
                    >
                        <Image
